...
SpriteGenerator::SpriteGenerator(const sf::Vector2u& windowDim, std::pair<float, float> center, unsigned int imageScaleFactor, complex(*funcToMap)(complex))
{

	this->windowDim = windowDim;
	this->center = center;
	this->imageScaleFactor = imageScaleFactor;
	this->funcToMap = funcToMap;
